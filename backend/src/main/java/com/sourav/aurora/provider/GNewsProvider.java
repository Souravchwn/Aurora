...
public class GNewsProvider extends AbstractNewsProvider {
    ...
    private String mapCategory(String category) {
        // GNews supported categories: general, world, nation, business, technology,
        // entertainment, sports, science, health
        return switch (category.toLowerCase()) {
            case "general", "world", "nation",
                 "business", "technology", "entertainment",
                 "sports", "science", "health" -> category.toLowerCase();
            default -> "general"; // safe fallback
        };
    }
